...
pub use matrix_sdk::encryption::verification::{CancelInfo, Emoji};
...
use crate::channel::{ActionSender, EventSender};

/// A [`Action`] sender for a task running a SAS verification listener.
